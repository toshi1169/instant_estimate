  ...
  String text(String japanese) {
    ...
    if (isTraditionalChinese) {
      final translated = const <String, String>{
        ...
        '平均生産性': '平均生產率',
        '平均実績生産性': '平均實績生產率',
        '平均実績歩掛（内部値）': '平均實績步掛（BUGAKARI）（內部值）',
        '平均時間当たり生産性': '平均每小時生產率',
        '最小歩掛': '最小步掛（BUGAKARI）',
        '最大歩掛': '最大步掛（BUGAKARI）',
        '保存': '儲存',
    ...
    return const <String, String>{
          ...
          '実績歩掛（内部値）': 'Actual BUGAKARI (internal)',
          ...
          '平均実績歩掛（内部値）': 'Average actual BUGAKARI (internal)',
