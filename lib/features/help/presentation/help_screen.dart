      ...
      body: SafeArea(
        child: ListView(
          ...
          children: const [
            ...
            _HelpSection(
              key: Key('helpSectionConvenientCalculations'),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const Text('関数電卓、便利計算、インスタント見積の主な使い方を確認できます。'),
                ],
              ),
            ),
          ],
